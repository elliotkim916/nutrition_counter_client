...
const ExerciseResultsTotals = props => {
  ...
  for (let i = 0; i < props.exerciseResults.length; i++) {
    ...
    exerciseTotals['nf_calories'] = exerciseTotals['nf_calories'] += Math.floor(props.exerciseResults[i].nf_calories);
    exerciseTotals['duration_min'] = exerciseTotals['duration_min'] += Math.floor(props.exerciseResults[i].duration_min);
